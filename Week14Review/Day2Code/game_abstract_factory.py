...
#Controller, will help me decide which Factory to use
...
def main():
    populator = WorldPopulator() #Helper to get the appropriate Factory
    #factory = populator.get_factory(WorldEnum.AQUATICA)
    factory = populator.get_factory(WorldEnum.FIRELANDS)

    world = World(factory) #all creatures instantiated in world
    world.simulate() #simulate creatures acting in the world
