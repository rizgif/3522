...
class Decorator(Component):
    ...
    class. It's CRITICAL that to pass in a component in the intializer.
...
wheat_donut = WheatDonut()
rice_donut = RiceDonut()
...
print(wheat_donut.description()) #G -> S -> WD
print(rice_donut.description()) #C -> S -> S -> RD